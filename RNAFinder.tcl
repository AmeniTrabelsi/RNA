...
proc vTclWindow.top37 {base} {
    ...
    wm geometry $top 2661x1880+757+89
    update
    # set in toplevel.wgt.
    global vTcl
    ...
    vTcl::widgets::ttk::scrolledtext::CreateCmd $top.scr79 \
        -background {#d9d9d9} -height 665 -highlightbackground {#d9d9d9} \
        -highlightcolor black -width 1052 
    vTcl:DefineAlias "$top.scr79" "Scrolledtext1" vTcl:WidgetProc "Toplevel1" 1
    ...
    place $top.lab73 \
        ...
        -anchor nw -bordermode ignore 
    place $top.scr79 \
        -in $top -x 890 -y 70 -width 1052 -relwidth 0 -height 665 \
        -relheight 0 -anchor nw -bordermode ignore 
